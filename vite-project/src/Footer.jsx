...
function Footer() {
  return (
    ...
    <div className="w-full rounded-[4px_24px_4px_24px] bg-gradient-to-r from-[#53683F] via-[#53683F] to-[#546940] flex flex-row mt-[5.9vw]">
      <div className="m-[65px_70px] flex flex-col font-['Libre_Baskerville'] font-bold w-[50.9vw]" style={{fontSize:"calc(0.0375*100vw)"}}>
        <a className="text-white">
          Align Your <span className="text-[var(--golden-yellow)]">Health</span>
          ,
        </a>
        <a className="text-white">Transform Your Life,</a>
        <a className="mt-[24px] font-['Inter'] font-normal text-[#CACACA]" style={{fontSize:"1.6vw"}}>
    ...
    <div className="relative ml-auto m-0 w-[100%]">
    <img
      src="image.png"
      style={{width:"43vw"}}
